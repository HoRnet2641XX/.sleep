...
export default function Error({
  ...
  useEffect(() => {
    // 開発中は内容確認のためコンソール出力
    logDevError("[app/error.tsx]", error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-5 bg-surface px-5 text-center">
      ...
      <div>
        <h1 className="mb-2 text-lg font-bold text-content">読み込みに失敗しました</h1>
        <p className="text-sm text-content-muted">時間をおいてもう一度お試しください。</p>
