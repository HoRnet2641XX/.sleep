    ...
    <main className="flex min-h-screen items-start justify-center bg-surface px-4 py-8">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex justify-end">
          <Link
            href="/"
            className="inline-flex min-h-[40px] items-center gap-2 rounded-lg border border-border px-3 py-2 text-sm font-medium text-content-secondary transition-colors hover:border-border-light hover:bg-surface-elevated hover:text-content"
          >
            <svg
              className="h-4 w-4"
              viewBox="0 0 24 24"
        ...
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-content">プロフィールを設定しましょう</h1>
        ...
        <p className="mt-6 text-center">
          <Link
            href="/"
            className="text-sm text-content-muted hover:text-content-secondary hover:underline"
          >
            あとで設定する
          </Link>
        </p>
